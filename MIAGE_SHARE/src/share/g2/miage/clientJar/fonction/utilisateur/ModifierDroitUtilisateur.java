 ...
 *
 */
public class ModifierDroitUtilisateur<T> extends FonctionClient<T> {
	
	/**
	 * demarre l'action "suppression d'un utilisateur"
	 */
	public ModifierDroitUtilisateur(String userName, String droit) {
		super();
		 parametre1 = userName;
		 parametre2 = droit;
		demarrer();
	...
	public int commExecuter1() {
		try {
			...
			dos.writeUTF(ParametreCJ.UTILISATEUR_MODIFIER_DROIT);
			dos.flush();
