...
public class StatUtils {
		...
		public static DefaultPieDataset createUpDownUtil(Hashtable<Integer, User> ht){
			...
			System.out.println("data créé");
			Iterator<Integer> it;
		    it=ht.keySet().iterator(); // on cree un iterator sur les clés du hashmap
		 ...
		 * @param data: données (générées précedemment)
		 * @return
		 */
		 ...
		 * @param chart: JFreeChart à afficher
		 */
